...
Import your theme file to your main application folder (you will need to create this yourself). When you're all finished, it should look something like this:
